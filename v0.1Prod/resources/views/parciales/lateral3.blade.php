<!-- component -->
<div class="flex flex-no-wrap h-100 pt-20">
    <!-- Sidebar starts -->
            ...
            <ul class="mt-12">
                ...
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                    <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <span class="text-sm ml-2">
                            <a href="{{ route('admin.documentos.index') }}" :active="request()->routeIs('documentos')">Documentos</a>
                        </span>
                    </a>
                </li>
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                ...
                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                    <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <span class="text-sm ml-2"><a href="{{ route('admin.etiquetas.index') }}" :active="request()->routeIs('etiquetas')">Etiquetas</span>
                    </a>
                </li>
                <li
                    ...
                    <a href="javascript:void(0)"
                        ...
                        <span class="text-sm ml-2"><a href="{{ route('admin.roles.index') }}" :active="request()->routeIs('roles')">Perfiles</span>
                    </a>
                </li>
                <li
                    class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                    <a href="javascript:void(0)"
                        ...
                        <span class="text-sm ml-2"><a href="{{ route('admin.permissions.index') }}" :active="request()->routeIs('permissions')">Permisos</span>
                    </a>
                </li>
            </ul>
