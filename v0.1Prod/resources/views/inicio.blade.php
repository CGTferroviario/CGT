...
<h1 class="m-0 py-3 text-center font-bold text-black grande bg-rojoBrillante">SECTOR FEDERAL FERROVIARIO DE CGT</h1>
...
<div class="container mt-10 mb-10">
    <div class="row">
        <div class="col-md-6">
            <a href="{{ route('biblioteca.comunicados') }}" class="centrado">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{ url('https://comoserferroviario.es/') }}" class="centrado" target="_blank">
