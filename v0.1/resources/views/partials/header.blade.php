<nav class="navbar navbar-expand-md navbar-dark bg-dark navbar fixed-top barraSup" id="barraSup" aria-label="Fourth navbar example">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="barraSup">
      ...
      <div class="modoOscuro inline me-auto">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li><a href="https://es-es.facebook.com/cgtferroviario/" title="Facebook SFFCGT" target="_blank"><i class="fa-brands fa-facebook sociales"></i></a></li>
        <li><a href="https://www.youtube.com/c/CGTSectorFederalFerroviario" title="Youtube SFFCGT" target="_blank"><i class="fa-brands fa-youtube sociales"></i></a></li>
      </ul>
      {{-- <form>
