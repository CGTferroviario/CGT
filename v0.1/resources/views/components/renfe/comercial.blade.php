            ...
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-8 d-flex flex-column">
                        <div class="card-body">
                            <h5 class="card-title">Plataforma reivindicativa de CGT para el Colectivo de Comercial/Taquillas</h5>
        ...
        <div class="col-sm-6">
            <div class="card mb-3">
                <div class="row g-0">
                    ...
                    <div class="col-md-8 d-flex flex-column">
                        <div class="card-body">
                            <h5 class="card-title">Acuerdo Desarrollo Profesional Colectivo Comercial</h5>
                            <p class="card-text">Establece y desarrolla el marco específico de relaciones laborales del colectivo de Comerciales y Taquillas.</p>
                        </div>
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <div class="col-md-6 centrado">
                                <a href="doc/AFILIACION/FICHA_AFILIACION_NOMINA.pdf" class="btn" target="blank"><i class="fa fa-eye"></i> Visualizar</a>
