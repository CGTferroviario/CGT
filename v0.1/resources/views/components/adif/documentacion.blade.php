<div class="py-4">
  <div class="container">
    <div class="accordion-flush" id="#accordionDoc">
        ...
        <div class="accordion-item collapseIgualdad">
            <h2 class="accordion-header">
        ...
        <div class="accordion-item collapseMedidas">
        ...
        <div class="accordion-item collapseProtocolos">
        ...
        <div class="accordion-item collapseTeletrabajo">
