<div>
 ...
 -->
  ...
  <div id="carouselMultiItemExample" class="carousel slide carousel-light text-center" data-mdb-ride="carousel">
  <!-- Controls -->
          ...
          <div class="row">
            <div class="col-lg-4">
              ...
              <img src="https://mdbcdn.b-cdn.net/img/new/standard/nature/181.webp" class="card-img-top" alt="Waterfall"/>
                <div class="card-body">
                  <h5 class="card-title">Logo CGT Ferroviario Color</h5>
                  <p class="card-text">En color 300x300</p>
            ...
            <div class="col-lg-4 d-none d-lg-block">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Logo CGT Ferroviario Blanco y Negro</h5>
                  <p class="card-text">B/N 300x300</p>
                  <a href="#!" class="btn btn-primary">Descargar</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 d-none d-lg-block">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Logo CGT</h5>
                  <p class="card-text">Logotipo CGT Confederal</p>
                  <a href="#!" class="btn btn-primary">Descargar</a>
                </div>
              </div>
            </div>
