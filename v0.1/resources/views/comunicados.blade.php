...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3 bg-oscuro blanco">
            <div class="bg-oscuro" width="100%">
                <h1 class="">Comunicado 1</h1>
                <p>Esto es un extracto</p>
            </div>
            <div class="bg-oscuro" width="100%" height="200px">
                <h1 class="">Comunicado 2</h1>
                <p>Esto es un extracto</p>
            </div>
            <div class="bg-oscuro" width="100%" height="200px">
                <h1 class="">Comunicado 3</h1>
                <p>Esto es un extracto</p>
            </div>
        </div>
    </div>
