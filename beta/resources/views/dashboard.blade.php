                ...
                <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
                    <div class="rounded-lg bg-red-500 hover:bg-black cursor-pointer group">
                        <a href="{{ route('profile.edit') }}">
                            ...
                            <h1 class="mb-4 p-4 text-3xl text-white bg-black group-hover:bg-red-500 group-hover:text-black text-center titular">{{ Auth::user()->nombre }}</h1>
                        </a>
                    </div>
                    <div class="rounded-lg bg-red-500 hover:bg-black cursor-pointer group">
                        <a href="{{ route('intranet.eslogans.index') }}">
                    ...
                    <div class="rounded-lg bg-red-500 hover:bg-black cursor-pointer group">
                        <a href="{{ route('intranet.sliders.index') }}">
                    ...
                    <div class="rounded-lg bg-red-500 hover:bg-black cursor-pointer group">
                        <a href="{{ route('intranet.estadisticas.index') }}">
