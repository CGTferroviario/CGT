...
@section('contenido')
<h1 class="m-0 py-3 text-center bg-rojoBrillante">MAPA SINDICAL - Sector Federal Ferroviario CGT</h1>
<br>
<div class="container">
        ...
        <div class="resp-table">
            ...
            <div class="resp-table-body">
                <div class="resp-table-row">
                    ...
                    <div class="table-body-cell">-----</div>
                    <div class="table-body-cell"><a href="mailto:cgtfgc@gmail.com">cgtfgc@cgtferroviario.es</a></div>
                </div>
            </div>
        </div>
    </div>
