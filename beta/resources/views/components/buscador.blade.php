    ...
    <form class="mx-auto">
        <div class="flex w-full">
            ...
            <div class="relative w-full">
                ...
                <button type="submit"
                    class="absolute top-0 end-0 p-2 text-sm font-medium h-full text-white bg-red-500 hover:bg-red-800 rounded-e-lg border border-red-700 focus:ring-4 focus:outline-none focus:ring-red-800">
