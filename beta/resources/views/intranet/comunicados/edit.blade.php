                            ...
                            <form action="{{ route('intranet.comunicados.update', $comunicado->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-4 sm:grid-cols-12 sm:gap-6 mt-3">
                                    <div>
                                        ...
                                        <input type="text" name="numero" id="numero" class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-gray-400" placeholder="" value="{{old('numero', $comunicado->numero)}}" required="">
                                    </div>
