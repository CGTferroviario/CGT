            ...
            <div class="grid grid-cols-3 mt-2 mb-3">
                ...
                <div class="sm:flex sm:items-center sm:justify-end">
                    <div class="flex items-center gap-x-3 align-middle">
                        ...
                        <button class="flex items-center justify-center w-1/2 px-2 py-2 text-sm text-gray-900 transition-colors duration-200 bg-rojoBrillante bordeNegro rounded-lg gap-x-2 sm:w-auto hover:bg-gray-900 hover:text-red-500" title="Editar un nuevo comunicado">
                        ...
                        <div class="py-8 px-4 mx-auto">
                            ...
                            <form action="{{ route('intranet.comunicados.update', $comunicado->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                    <x-select-empresa-edit :empresas=$empresas :tipo=$comunicado></x-select-empresa>

                                    <x-select-categoria-edit :categorias=$categorias :tipo=$comunicado></x-select-categoria>
                                    
                                    <x-select-etiquetas-edit :etiquetas=$etiquetas :tipo=$comunicado></x-select-etiquetas>
                                ...
                                <div class="grid gap-4 sm:grid-cols-12 sm:gap-6 mt-3">
                                    <div>
                                        ...
                                        <input type="number" name="numero" id="numero" class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-gray-400" placeholder="" value="{{old('numero', $comunicado->numero)}}" required="">
                                    </div>
                                    <div class="col-span-5">
                                        <label for="titulo" class="block mb-2 text-sm font-medium text-white">Título</label>
                                        <input type="text" name="titulo" id="titulo" class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-gray-400" placeholder="" value="{{ $comunicado->titulo }}" required="">
                                    </div>
                                    <div class="col-span-6">
                                        <label for="subtitulo" class="block mb-2 text-sm font-medium text-white">Subtítulo</label>
                                        <input type="text" name="subtitulo" id="subtitulo" class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-gray-400" placeholder="" value="{{ $comunicado->subtitulo }}" required="">
                                    </div>
                                </div>
                                ...
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mt-3">
                                    <div class="col-span-2">
                                        ...
                                        <textarea id="cuerpo" name="cuerpo" rows="20" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="El cuerpo del comunicado..." value="">
                                            {{ $comunicado->cuerpo }}
                                        </textarea>
                                    </div>
                                </div>
