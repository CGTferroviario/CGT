        ...
        <div class="bg-blanco-transp bordeRojo rounded-lg p-4">
            <div class="grid grid-cols-3 mt-2 mb-3">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <button class="flex items-center justify-center w-1/2 px-2 py-2 text-sm text-zinc-900 transition-colors duration-200 bg-red-500 bordeNegro rounded-lg gap-x-2 sm:w-auto hover:bg-zinc-900 hover:text-red-500" title="Volver a Seccion">
                        ...
                        <form action="{{ route('intranet.seccions.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6 mt-3">
                                <div class="">
                                    ...
                                    <input id="nombre" name="nombre" type="text" value="{{ old('nombre') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Nombre Sección">
                                </div>
                                <div class="">
                                    <label for="email" class="block mb-2 text-sm font-medium text-white">Email</label>
                                    <input id="email" name="email" type="email" value="{{ old('email') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="ejemplo@ejemplo.com"></input>
                                </div>
                                <div class="">
                                    <label for="email2" class="block mb-2 text-sm font-medium text-white">Email secundario</label>
                                    <input id="email2" name="email2" type="email" value="{{ old('email2') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="ejemplo2@ejemplo.com"></input>
                                </div>
                                <div class="">
                                    <label for="telefono" class="block mb-2 text-sm font-medium text-white">Teléfono</label>
                                    <input id="telefono" name="telefono" type="text" value="{{ old('telefono') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="666 887766"></input>
                                </div>
                                <div class="col-span-2">
                                    <label for="direccion" class="block mb-2 text-sm font-medium text-white">Dirección</label>
                                    <input id="direccion" name="direccion" type="text" value="{{ old('direccion') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Avda. Ciudad de Barcelona 10 Sotano 2"></input>
                                </div>
                                <div class="col-span-2">
                                    <label for="descripcion" class="block mb-2 text-sm font-medium text-white">Descripción</label>
                                    <input id="descripcion" name="descripcion" type="text" value="{{ old('descripcion') }}" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Esta sección se ocupa de..."></input>
                                </div>
