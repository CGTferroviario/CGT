        ...
        <div class="bg-blanco-transp bordeRojo rounded-lg p-4">
            <div class="grid grid-cols-3 mt-2 mb-3">
                ...
                <div class="sm:flex sm:items-center sm:justify-start">
                    <button class="flex items-center justify-center w-1/2 px-2 py-2 text-sm text-zinc-900 transition-colors duration-200 bg-rojoBrillante bordeNegro rounded-lg gap-x-2 sm:w-auto hover:bg-zinc-900 hover:text-red-500" title="Volver al Índice de Documento">
                        ...
                        <div class="py-8 px-4 mx-auto">
                            ...
                            <form action="{{ route('intranet.documentos.update', $documento->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                    ...
                                    <x-forms.select-empresa-edit :empresas=$empresas :tipo=$documento></x-select-empresa-edit>

                                    <x-forms.select-categoria-edit :categorias=$categorias :tipo=$documento></x-select-categoria-edit>
                                    
                                    <x-forms.select-etiquetas-edit :etiquetas=$etiquetas :tipo=$documento></x-select-etiquetas-edit>
                                ...
                                <div class="grid gap-4 sm:grid-cols-12 sm:gap-6 mt-3">
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="titulo" id="titulo" class="w-full bg-zinc-700 border border-zinc-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-zinc-400" placeholder="" value="{{ $documento->titulo }}" required="">
                                        <div class="">
                                            <label for="descripcion" class="block mb-2 text-sm font-medium text-white">Descripción</label>
                                            <textarea id="descripcion" rows="5" name="descripcion" class="block p-2.5 w-full text-sm text-white bg-zinc-700 rounded-lg border border-zinc-600 focus:ring-red-500 focus:border-red-500 placeholder-zinc-400" placeholder="Una descripción del documento...">{{ $documento->descripcion }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-span-6">
