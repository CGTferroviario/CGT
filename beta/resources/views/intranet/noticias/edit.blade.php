                        ...
                        <div class="py-8 px-4 mx-auto">
                            ...
                            <form action="{{ route('intranet.noticias.update', $noticia->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                                    ...
                                    <x-forms.select-categoria-edit :categorias=$categorias :tipo=$noticia></x-select-categoria-edit>

                                    <x-forms.select-etiquetas-edit :etiquetas=$etiquetas :tipo=$noticia></x-select-etiquetas-edit>
                                ...
                                <div class="grid gap-4 sm:grid-cols-12 sm:gap-6 mt-3">
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="titulo" id="titulo" class="w-full bg-zinc-700 border border-zinc-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-zinc-400" placeholder="" value="{{ $noticia->titulo }}" required="">
                                        <div class="">
                                            <label for="cuerpo" class="block mb-2 text-sm font-medium text-white">Descripción</label>
                                            <textarea id="cuerpo" rows="5" class="block p-2.5 w-full text-sm rounded-lg border focus:ring-red-500 focus:border-red-500 bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white" placeholder="El cuerpo de la noticia..." name="cuerpo">
                                                {{ $noticia->cuerpo }}
                                            </textarea>
                                        </div>
                                    </div>
