        ...
        <div class="bg-blanco-transp bordeRojo rounded-lg p-4">
            <div class="grid grid-cols-3 mt-2 mb-3">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <button class="flex items-center justify-center w-1/2 px-2 py-2 text-sm text-zinc-900 transition-colors duration-200 bg-rojoBrillante bordeNegro rounded-lg gap-x-2 sm:w-auto hover:bg-zinc-900 hover:text-red-500" title="Volver a Equipo">
                ...
                <div class="sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-x-3">
                        <h2 class="text-lg font-bold text-zinc-800">Equipos</h2>
                        <span class="px-3 py-1 text-xs text-red-600 bg-red-200 rounded-full">{{ $equipos->count() }}</span>
                        <p class="mt-1 text-sm text-zinc-500">Estas son las equipos que tenemos registradas.</p>
                    </div>
                </div>
                        ...
                        <form action="{{ route('intranet.equipos.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6 mt-3">
                                ...
                                <div class="">
                                    ...
                                    <input id="cargo" name="cargo" type="text" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Cargo en la organización">
                                </div>
                                <div class="">
                                    <label for="usuario" class="block mb-2 text-sm font-medium text-white">Usuario</label>
                                    <input id="usuario" name="usuario" type="text" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Pepito Pérez"></input>
                                </div>
                                <div class="">
                                    <label for="email" class="block mb-2 text-sm font-medium text-white">Email</label>
                                    <input id="email" name="email" type="email" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="ejemplo@ejemplo.com"></input>
                                </div>
                            </div>
