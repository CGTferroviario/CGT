            ...
            <div class="grid grid-cols-3 mt-2 mb-3">
                ...
                <div class="sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center gap-x-3">
                        <h2 class="text-lg font-bold text-gray-800">Editar Equipos</h2>
                        ...
                        <form action="{{ route('intranet.equipos.update', $equipo->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6 mt-3">
                                ...
                                <div class="">
                                    ...
                                    <input id="cargo" name="cargo" type="text" value="{{ $equipo->cargo }}" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Cargo en la organización">
                                </div>
                                <div class="">
                                    <label for="usuario" class="block mb-2 text-sm font-medium text-white">Usuario</label>
                                    <input id="usuario" name="usuario" type="text" value="{{ $equipo->usuario }}" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Pepito Pérez"></input>
                                </div>
                                <div class="">
                                    <label for="email" class="block mb-2 text-sm font-medium text-white">Email</label>
                                    <input id="email" name="email" type="email" value="{{ $equipo->email }}" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="ejemplo@ejemplo.com"></input>
                                </div>
                            </div>
