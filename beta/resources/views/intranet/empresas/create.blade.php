                                ...
                                <div class="col-span-3">
                                    <div class="grid gap-4 sm:grid-cols-5 sm:gap-6 mt-3">
                                        <div class="col-span-2">
                                            ...
                                            <input type="text" name="nombre" id="nombre" class="w-full bg-zinc-700 border border-zinc-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 placeholder-zinc-400" placeholder="" value="" required="">
                                        </div>
                                        ...
                                        <div class="col-span-5">
                                            ...
                                            <textarea id="descripcion" name="descripcion" rows="5" class="block p-2.5 w-full text-sm rounded-lg border bg-zinc-700 border-zinc-600 dark:placeholder-zinc-400 text-white focus:ring-red-500 focus:border-red-500" placeholder="Descripción de la empresa y sus funciones..."></textarea>
                                        </div>
                                    </div> 
                                </div>
