                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-start gap-1 text-xl mt-2">
                                        {{-- <a x-data="{ tooltip: 'Enviar' }" href="{{ url('categorias.edit', $categoria->id) }}"
                                        ...
                                        <form method="POST" action="{{ url('categorias.destroy', $categoria->id) }}" onsubmit="return confirm('¿Deseas eliminar este categoria?');">
                                            @csrf
                                            @method('DELETE')
