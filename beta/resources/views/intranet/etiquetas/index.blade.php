            ...
            <div class="grid grid-cols-3 mt-2 mb-3">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="inline-flex overflow-hidden text-white divide-x rounded-lg rtl:flex-row-reverse">
                        ...
                        <button class="px-3 py-2 text-xs font-medium bg-oscuro transition-colors duration-200 sm:text-sm hover:bg-red-500 hover:text-gray-900" title="Etiquetas en activo">
                            Activas
                        </button>
                ...
                <div class="sm:flex sm:items-center sm:justify-end">
                    <div class="flex items-center gap-x-3 align-middle">
                        ...
                        <button class="flex items-center justify-center w-1/2 px-2 py-2 text-sm text-gray-900 transition-colors duration-200 bg-rojoBrillante bordeNegro rounded-lg gap-x-2 sm:w-auto hover:bg-gray-900 hover:text-red-500" title="Añadir un nuevo etiqueta">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-start gap-1 text-xl mt-2">
                                        <a x-data="{ tooltip: 'Edite' }" href="{{ url('etiquetas.edit', $etiqueta->id) }}"
                                        ...
                                        <form method="POST" action="{{ url('etiquetas.destroy', $etiqueta->id) }}" onsubmit="return confirm('¿Deseas eliminar este etiqueta?');">
                                            ...
                                            <button type="submit" class=" p-1 rounded-md">
                                                <a x-data="{ tooltip: 'Delete' }" href="#" title="Eliminar etiqueta" class="text-red-500 hover:bg-red-500 hover:text-white p-1 rounded-lg h-8">
                                ...
                                <td class="text-center">{{ $etiqueta->activa }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
