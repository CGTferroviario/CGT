...
@section('contenido')
<h1 class="m-0 py-3 text-center bg-ADIF font-bold">INFRAESTRUCTURA</h1>
<div class="fondo infraestructura">
    ...
    <div class="grid grid-cols-4 gap-4 p-4">
        <div class="bg-grisOscuro-7 text-white mb-3 rounded-lg bordeRojo" style="">
            <div class="p-2"><h2 class="text-xl font-bold">Plataforma Reivindicativa INFRAESTRUCTURA</h2></div>
            <div class="p-2 bordeRojo">
                <span class="rounded-full bg-ADIF px-2 py-0.5">ADIF</span>
                <span class="rounded-full bg-INFRAESTRUCTURA px-2 py-0.5">INFRAESTRUCTURA</span>
