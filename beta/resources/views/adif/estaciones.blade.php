            ...
            <div class="buscador">
                <form>
                    <div class="flex">
                        ...
                        <button id="dropdown-button" data-dropdown-toggle="dropdownBuscador" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center border rounded-l-lg focus:ring-2 focus:outline-none bg-zinc-700 hover:bg-zinc-600 focus:ring-red-700 text-white border-zinc-600" type="button">Categorías <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                        </button>
                        <div id="dropdownBuscador" class="z-10 hidden divide-y divide-zinc-100 rounded-lg shadow w-44 bg-zinc-700">
                            <ul class="py-2 text-sm text-zinc-200" aria-labelledby="dropdown-button">
                                <li>
                                    <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-zinc-600 hover:text-white">Etiquetas</button>
                                </li>
                                <li>
                                    <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-zinc-600 hover:text-white">Empresas</button>
                                </li>
                            </ul>
                        </div>
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-zinc-900 bg-zinc-50 rounded-r-lg border-l-zinc-50 border-l-2 border border-zinc-300 focus:ring-red-500 focus:border-red-500 dark:bg-zinc-700 dark:border-l-zinc-700  dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:border-red-500" placeholder="Search Mockups, Logos, Design Templates..." required>
