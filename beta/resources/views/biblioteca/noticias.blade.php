                ...
                @foreach ($noticias as $noticia)
                    ...
                    <div class="mb-4 shadow hover:shadow-lg h-full flex flex-col bordeRojo rounded-lg">
                        ...
                        <div class="p-2 text-sm text-white bg-black">
                            <span
                                class="py-0.5 px-2 rounded-full font-semibold bg-{{ $noticia->empresa?->nombre }}">{{ $noticia->empresa?->nombre }}</span>
                            <span
                                class="py-0.5 px-2 rounded-full font-semibold bg-{{ $noticia->categoria?->nombre }}">{{ $noticia->categoria?->nombre }}</span>
                            <span
                                class="py-0.5 px-2 rounded-full font-semibold bg-blue-400">{{ $noticia->etiqueta?->nombre }}</span>
                        </div>
