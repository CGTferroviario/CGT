<x-publico-layout>
    ...
    @section('contenido')
        <h1 class="m-0 py-3 text-center bg-rojoBrillante font-bold">NOTICIAS</h1>
        <div class="fondo comunicados">
                    ...
                    <form class="">
                        <div class="flex w-full">
                            <button id="dropdown-button-2" data-dropdown-toggle="dropdown-search-city"
                                class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-md font-medium text-center text-zinc-500 bg-zinc-100 border border-zinc-300 rounded-l-lg hover:bg-zinc-200 focus:ring-4 focus:outline-none focus:ring-zinc-100 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:focus:ring-zinc-700 dark:text-white dark:border-zinc-600"
                                type="button">
                                <i class="lni lni-tag mr-2"></i> <span class="">Etiqueta</span> <i
                                    class="lni lni-chevron-down ml-2"></i>
                            </button>
                            <div id="dropdown-search-city"
                                class="z-10 hidden bg-white divide-y divide-zinc-100 rounded-lg shadow w-44 dark:bg-zinc-700">
                                <ul class="py-2 text-md text-zinc-700 dark:text-zinc-200"
                                    aria-labelledby="dropdown-button-2">
                                    <li>
                                        <button type="button"
                                            class="inline-flex w-full px-4 py-2 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-white"
                                            role="menuitem">
                                    ...
                                    <li>
                                        <button type="button"
                                            class="inline-flex w-full px-4 py-2 text-sm text-zinc-700 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-600 dark:hover:text-white"
                                            role="menuitem">
                                            <div class="inline-flex items-center">
                            ...
                            <div class="relative w-full">
                                <input type="search" id=location-search"
                                    class="block p-2.5 w-full z-20 text-xl text-zinc-900 bg-zinc-50 rounded-r-lg border-l-zinc-50 border-l-2 border border-zinc-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-700 dark:border-l-zinc-700  dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:border-blue-500"
            ...
            <div class="flex w-full justify-end p-4">
                <div class="w-1/4">
                    <label for="large" class="block mb-2 text-base font-medium text-zinc-900 dark:text-white">Elige una
                        etiqueta</label>
                    <select id="large"
                        class="block w-full px-4 py-3 text-base text-zinc-900 border border-zinc-300 rounded-lg bg-zinc-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-700 dark:border-zinc-600 dark:placeholder-zinc-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
