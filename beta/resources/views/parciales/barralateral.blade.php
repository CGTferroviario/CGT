...
<aside id="sidebar-multi-level-sidebar"
    ...
    <div class="h-full px-3 py-4 pt-5 sm:overflow-y-hidden md:overflow-y-auto bg-oscuro">
        ...
        <ul class="space-y-2 font-medium mt-5">
            <li class="">
                {{-- flex items-center justify-between w-full border-b md:border-0 md:p-2 md:w-auto text-white md:hover:text-black focus:text-white border-gray-700 md:hover:bg-red-500 active:text-red-500 rounded-lg p-2 --}}
            ...
            <li class="">                    
                <a href="{{ route('intranet.secciones.index') }}" :active="request()->routeIs('secciones')" class="flex items-center p-2 rounded-lg text-white hover:bg-red-500 group hover:text-black">
