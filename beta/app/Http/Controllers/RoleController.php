...
class RoleController extends Controller
{
    ...
    {
        return view('intranet.roles.create');
    }
    public function store(Request $request)
    {
        ...
        return to_route('intranet.roles.index')->with('message', 'Role Created Successfully');
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return to_route('intranet.roles.index')->with('message', 'Role Updated Successfully');
    }
